...
Refer to the [HaploGI manual](https://github.com/RafPrograms/HaploGI/blob/main/docs/readme.md) for detailed instructions on parameter settings and command-line options.
...
- 📄 [HaploGI manual (Markdown)](https://github.com/RafPrograms/HaploGI/blob/main/docs/readme.md)  
or
